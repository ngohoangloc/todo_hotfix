...
<li class="list-project-item" data-project-id="<?= $item->id ?>" <?= !$is_superadmin && $item->is_private ? "hidden" : "" ?>>
    <div class="list-project-link">
        <?php if ($item->type_id == 32) : ?>
            <a href="<?= base_url(); ?>timetable/view/<?= $item->parent_id ?>/<?= $item->id ?>" data-id="<?= $item->id; ?>" style="gap: 10px;" class="text-decoration-none d-flex text-center align-items-center">
                <div class="project-icon">
                    <i class="fa fa-calendar" aria-hidden="true"></i>
                </div>
                <div class="project_title" data-project-id="<?= $item->id ?>" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-title="<?= $item->title; ?>">
        ...
        <?php elseif ($item->type_id == 31) : ?>
            <a href="<?= base_url(); ?>customtable/view/<?= $item->parent_id ?>/<?= $item->id ?>" data-id="<?= $item->id; ?>" style="gap: 10px;" class="text-decoration-none d-flex text-center align-items-center">
                <div class="project-icon">
