                        ...
                        <div class="group-item-title mb-3">
                            <div class="row me-0">
                                ...
                                <div class="col-12 col-md-4 col-lg-5 d-flex justify-content-end gap-2">
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddMember<?= $group->id ?>" aria-labelledby="offcanvasAddMemberLabel">
                                        ...
                                        <div class="offcanvas-body">
                                            <div class="add-group-member">
                                                <button class="btn btn-sm btn-outline-secondary" type="button" data-bs-toggle="modal" data-bs-target="#addGroupRoleModal-<?= $group->id ?>"><i class="fa fa-plus"></i> Thêm nhóm phân quyền</button>
                                            </div>
                                            <div class="group-member-<?= $group->id ?>">
                                                <!-- Project owner -->
                                                    ...
                                                    <div class="member-section">
                                                        <div class="member-header">
                                                            <div class="config">
                                                                ...
                                                                <button class="btn btn-sm btn-permission-config" type="button" data-group-id="<?= $group->id ?>" data-bs-toggle="modal" data-bs-target="#permissionModal">
                                                                    <i class="fa fa-cog"></i>
                                                                </button>
                                                            </div>
                                                            <div class="add-member">
                                                                <button class="btn btn-sm btn-add-member" type="button" data-group-id="<?= $group->id ?>"><i class="fa fa-plus"></i></button>
                                                            </div>
                                                        </div>
                                                        <div class="member-list">
                                                            <!-- Display owner details -->
                                                            <div class="member">
                                                                <img src="<?= base_url() . $project_owner->avatar ?>" alt="Owner Avatar">
                                                                <div>
                                                                    <div class="name"> <?= $project_owner->firstname . " " . $project_owner->lastname ?></div>
                                                                    <div class="position"><?= $project_owner->department_name ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <!-- Group roles -->
                                                <?php if (isset($items_roles_by_group[$group->id]) && !empty($items_roles_by_group[$group->id])) : ?>
                                                    <?php foreach ($items_roles_by_group[$group->id] as $item_role) : ?>
                                                        <?php
                                                        $data['group'] = $group;
                                                        $data['items_role'] = $item_role;
                                                        $this->load->view("admin/views/components/items_role/member-section", $data);
                                                        ?>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <!-- add role for group modal-->
                                    <div class="modal fade" id="addGroupRoleModal-<?= $group->id ?>" tabindex="-1" aria-labelledby="addGroupRoleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form class="addGroupRole" data-group-id="<?= $group->id ?>">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="items_id" value="<?= $group->id ?>" hidden>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="permissionModal" tabindex="-1" role="dialog" aria-labelledby="permissionModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form id="set_permission_for_role" method="post" action="<?= base_url() . "items_role/set_permission" ?>">
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-primary" id="savePermissionsBtn">Lưu lại</button>
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                                                    </div>
                                    ...
                                    <!-- add user to item role in group Toản thêm 15/06/2026  -->
                                    <div class="modal fade" id="add_user_to_role_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Danh sách người dùng có trong nhóm</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body" style="min-height: 500px;">
                                                    <form id="add_owners_to_role_form" method="post" action="<?= base_url() . "items_role/add_users_to_role" ?>">
                                                        <input type="hidden" name="role_id" id="role_id">
                                                        <!-- <input id="search-users-to-invite-group" type="text" class="form-control" placeholder="Tìm kiếm username hoặc email"> -->



                                                        <select id="search-department-role" type="text" class="form-control mb-2" placeholder="Tìm kiếm phòng ban">

                                                        </select>
                                                        <input id="search-users-to-invite-group-role" type="text" class="form-control" placeholder="Tìm kiếm username hoặc email">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-primary" id="add_user_to_role">Lưu lại</button>
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                                                </div>
                                            </div>
                                        </div>
