...
$config['base_url'] = 'http://localhost/todo_hotfix/';  
// $config['base_url'] = 'https://nvt.vieit.net/todo/';
// $config['base_url'] = 'https://todo.nctu.edu.vn/';
...
//config bảng
// $config['id_bang_phong_ban'] = 1789;

$config['id_bang_phong_ban']        = 1945;
$config['id_bang_release_notes']    = 2434;

// File serect key
$config['image_key']                = "bgxvtczxwg";
...
$config['FOLDER_ID']            = 7;
$config['BOARD_ID']             = 27;
$config['DEPARTMENT_ID']        = 30;
$config['TALBE_ID']             = 31;
$config['TIMETALBE_ID']         = 32;
$config['TIMETALBE_ITEM_ID']    = 33;